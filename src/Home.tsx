...
const Home: React.FC = () => {
  ...
  return (
    loading ? (
      ...
      <div>
        <div className="Home1 outfit-font pt-28 flex gap-6 flex-col md:flex-row items-center justify-center min-h-full md:min-h-screen bg-themelight dark:bg-themebg">
          {/* Left Section */}
